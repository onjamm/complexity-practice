...
public class Main {
  ...
  //Where n represents the length of either array
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is:
  // Constant - O(1) - (HashSet.contains is an O(1) operation)
  ...
  // Linear Growth - O(n)
  //Where n represents the length of names
  ...
  // Constant growth - O(1) - (HashMap.containsKey() is an O(1) operation)
